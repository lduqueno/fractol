...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/05 19:11:25 by lduqueno          #+#    #+#             */
/*   Updated: 2019/06/05 17:51:29 by lduqueno         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				ft_putdble_fd(double d, int fd);
void			ft_putchar(char c);
void			ft_putstr(char const *s);
void			ft_putendl(char const *s);
void			ft_putnbr(int n);
int				ft_putdble(double n);
...
char			*ft_strmult(char *s1, char *s2);
